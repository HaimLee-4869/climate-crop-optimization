...
> **핵심 메시지 — "더위가 옥수수를 해치고, 적은 작물 대체로 손실을 상당 부분 만회할 수 있다.
> 그리고 그 대체의 방향 — 남부에서 옥수수가 밀로 — 은 가격 가정이 아니라 작물의 고온 반응에서 나온다."**

> ⚠ 이는 **작물 대체**(각 카운티가 어느 작물을 심는가)이지 **"재배 벨트의 북상·이동"이 아닙니다.**
> 본 저장소는 벨트 이동(H8)에 대해 어떤 주장도 하지 않습니다 — [한계](#한계) 참조.
...
| **남부의 밀 전환** | 밀이 **남부**에서 선택 (TX·OK·VA·MO·AR·GA) — 213 카운티, 평균 위도 36.1° (전국 38.3°) |
...
- **⛔ "재배 벨트 북상"(H8)은 이 연구의 범위 밖입니다. 본 저장소는 H8에 대해 어떤 주장도 하지 않습니다.**
  판정할 수 없는 이유는 두 가지입니다. **(1) 최적화의 카운티 집합이 고정돼 있습니다** — 세 작물이 모두
  관측되는 2,056개 카운티 *안에서만* 재배분하므로, 현재 미재배 지역으로의 **재배 프론티어 확장**을
  구조적으로 표현할 수 없습니다. **(2) 온도 채널에 북상의 동력이 없습니다** — 모델은 29℃ 초과 고온 피해만
  보고, 벨트를 북으로 미는 생육기간 연장·서리일수 감소·적산온도가 피처셋에 없습니다.
  실측으로도 옥수수 무게중심 위도는 **+0.05° 이동에 그치고**(사실상 0), 옥수수는 **모든 위도대에서 줄며
  감소폭이 가장 큰 곳은 오히려 최북단**(42–49°N, −12.9%p)입니다.
  → 모델이 북상을 *부정한* 것이 아니라 **측정할 수 없는** 것입니다.
  **"남부가 밀로 전환된다"는 결과와 혼동하지 마세요** — 그것은 남부 카운티 *내부에서* 옥수수가 밀로
  바뀐다는 뜻이지, 벨트가 북으로 이동한다는 뜻이 아닙니다. 자세한 내용은 최종 보고서 §9.1을 참조하세요.
